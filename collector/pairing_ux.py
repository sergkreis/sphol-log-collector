...
class PairingUX:
    ...
    def refresh_pairing_ux(self):
        ...
        self.retry_button.config(state='disabled' if self.busy or (self.pairing and not getattr(self.pairing, 'durable', False)) or getattr(self, 'redemption_uncertain', False) else 'normal')
